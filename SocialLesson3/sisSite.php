...
<center><H3>WELCOME TO SOCIAL LESSON 3</H3></center><p>
<?php
...
?>
		This study seeks to understand how people decide whether or not it is secure to sign-in to different websites on the Internet. Your task involves visiting a series of websites and deciding whether or not they are secure enough to sign-in.   
            <?php
            if($_SESSION['type'] == 'mturk'){
