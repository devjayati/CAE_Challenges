...
function showFinish(){
	switch(which_set){
		...
		case 'validation':
		console.log("HERE");
		$.post('../SocialLesson3/PHP/dataReceiver.php', $("#surveyResults").serialize());
		$("#sis").hide();
		popup("../SocialLesson3/PHP/experiment.php");
		$("#question").html("<h3>Please leave this window open while completing the site tasks. Closing or reloading this page will invalidate the results and you will not get a completion flag.</h3>").show();
		questions = cultureQuestions.concat(skill_questions);
                which_set = "skills";
		break;
		default:
